...
Keeping users safe and secure is a top priority for us.
...
Security issues can be reported by sending an email to `skilite007@gmail.com`,
which will go to the maintainers.
...
We supports safe harbor for security researchers who:
